...
export const createBoolBuilder = <T>(state: QueryState = {}): BoolBuilder<T> => {
        ...
        Monad<T>(state).map(s => {
          ...
          return {
            ...
            query: {
              bool: {
                ...boolState.query.bool,
                should: [...(boolState.query.bool.should || []), innerState.query]
              }
            }
          };
        }).fold()
        ...
        Monad<T>(state).map(s => {
          ...
          return {
            ...
            query: {
              bool: {
                ...boolState.query.bool,
                must_not: [...(boolState.query.bool.must_not || []), innerState.query]
              }
            }
          };
        }).fold()
        ...
        Monad<T>(state).map(s => {
          ...
          return {
            ...
            query: {
              bool: {
                ...boolState.query.bool,
                filter: [...(boolState.query.bool.filter || []), innerState.query]
              }
            }
          };
        }).fold()
